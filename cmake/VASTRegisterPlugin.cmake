...
function (VASTRegisterPlugin)
  ...
  add_library(${PLUGIN_TARGET} STATIC ${PLUGIN_ENTRYPOINT} ${PLUGIN_SOURCES})
  ...
  if (VAST_ENABLE_STATIC_PLUGINS)
    ...
    target_link_libraries(${PLUGIN_TARGET}-shared PRIVATE ${PLUGIN_TARGET}
                                                          vast::internal)
    ...
    if (TARGET vast-man)
      add_dependencies(vast-man ${PLUGIN_TARGET}-shared)
    endif ()
  endif ()
